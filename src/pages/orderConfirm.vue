<template>
  <div class="order-confirm">
    ...
    <div class="wrapper">
      <div class="container">
        <div class="order-box">
          <div class="item-address">
            ...
            <div class="addr-list clearfix">
              <div class="addr-info" :class="{'checked':index==checkedIndex}" @click="checkedIndex=index" v-for="(item,index) in list" :key="index">
                ...
                <div class="phone">电话：{{item.receiverMobile}}</div>
                <div class="street">地址：{{item.receiverProvince + " " + item.receiverCity + " " + item.receiverDistrict + " " + item.receiverAddress}}</div>
                <div class="action">
          ...
          <div class="detail">
            <div class="item">
              <span class="item-name">商品数量：</span>
          ...
          <div class="btn-group">
            <a href="/#/cart" class="btn btn-default">返回购物车</a>
    ...
    <!-- 新增删除的弹框 -->
      <modal title="确认删除" btnType="1" :showModal="showDelModal"
