    ...
    <div class="wrapper">
      <div class="container clearfix">
        ...
        <div class="content">
          ...
          <p class="item-info">相机全新升级 / 960帧超慢动作 / 手持超级夜景 / 全球首款双频GPS / 骁龙845处理器 / <br/>红外人脸解锁 / AI变焦双摄 / 三星 AMOLED 屏</p>
          ...
          <div class="item-color">
            <h2>选择颜色</h2>
            <div class="select c1" :class="{'checked':version==1}" @click="version=1"><span class="color1"></span>深空灰</div>
            <div class="select c2" :class="{'checked':version==2}" @click="version=2"><span class="color2"></span>冰雪白</div>
          </div>
          <div class="item-total">
            <div class="phone-info clearfix">
              <div class="fl">{{product.name}} 
                {{version==1?'6GB+64GB 全网通':'4GB+64GB 移动4G'}} 
                {{version==1?'深空灰':'冰雪白'}}</div>
